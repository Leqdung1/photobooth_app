...
<img alt="Collage Preview" class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDaLsoK9mNDOqbIXwGDLBJMnWQLuBHlqlnVUb4JkrtUkaJlyaNh4gMuBRwEE247oZexdfa5iMPloYJJs5EgzbHrJoJZ6yN7RkCLXxewgjzPy00So5Y--I4n0enMR6y1rrBrmBjZnXYeS5Fwe6fCP8zvbhVznpjR5QeWGiZ9Vu7zYvyD1nNs1jJzslWraqn7golp9_exWF4mJ9u_OSiks4_iCNnZJt7OvSL7IXoUcRLT2rb2HSJ9VH6N57n7CVH7IpfgEbOPvs1pFR_M">
</div>
</div>
<!-- Settings Panel -->
...
<!-- Modal Footer -->
<div class="p-6 border-t border-outline-variant flex justify-end bg-surface-container-highest/30"><div class="flex-1 flex flex-col gap-2" id="export-processing-state" style="display: none;">
<div class="flex justify-between items-end mb-1">
<span class="text-label-md font-medium text-primary">Exporting Collage...</span>
...
<div class="h-full bg-primary w-[45%] transition-all duration-300"></div>
</div>
</div>
<div class="flex items-center gap-4">
<button class="px-6 py-3 rounded-xl font-bold text-on-surface-variant hover:bg-surface-variant transition-colors" id="cancel-export-btn" style="display: none;">Cancel</button>
<button class="bg-primary text-on-primary px-10 py-3 rounded-xl font-bold hover:scale-105 active:scale-95 transition-all shadow-lg flex items-center gap-2" id="start-export-btn">
...
<div class="fixed bottom-8 right-8 z-[150] flex flex-col gap-3 pointer-events-none" id="notifications-container">
<!-- Success Toast -->
<div class="flex items-center gap-4 bg-surface-container-high border border-outline-variant p-4 rounded-xl shadow-2xl min-w-[320px] pointer-events-auto animate-in slide-in-from-right duration-300">
<div class="w-10 h-10 rounded-full bg-tertiary/20 flex items-center justify-center text-tertiary">
<span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">check_circle</span>
</div>
<div class="flex-1">
<p class="font-label-md text-on-surface">Export Successful!</p>
<p class="text-[11px] text-on-surface-variant">File saved to /exports and sent to mobile.</p>
</div>
...
<div class="flex-1">
<p class="font-label-md text-on-surface">Printing Failed</p>
<p class="text-[11px] text-on-surface-variant">Please check your printer connection.</p>
</div>
<button class="text-on-surface-variant hover:text-on-surface">
<span class="material-symbols-outlined text-lg">close</span>
</button>
